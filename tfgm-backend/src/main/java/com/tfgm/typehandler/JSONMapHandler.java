...
public class JSONMapHandler extends BaseTypeHandler<Map<String, Object>> {
  ...
  @Override
  public Map<String, Object> getNullableResult(final ResultSet resultSet, final String columnName)
      throws SQLException {
  ...
  @Override
  public Map<String, Object> getNullableResult(final ResultSet resultSet, final int columnIndex)
      throws SQLException {
